...
export const OTPInput = React.forwardRef<OtpInputRef, OTPInputProps>(
  (
      ...
      switch (variant) {
        case 'filled':
          return {
            pinCodeContainer: {
              ...baseStyle,
              backgroundColor: hasError ? `${theme.colors.error}10` : `${theme.colors.muted}80`,
              borderWidth: 0,
            },
            focusedContainer: {
        ...
        default:
          return {
            pinCodeContainer: {
              ...
              borderWidth: 0,
              borderBottomWidth: 2,
              borderBottomColor: hasError ? theme.colors.error : theme.colors.border,
              borderRadius: 0,
            },
            focusedContainer: {
              borderBottomWidth: 2,
    ...
    const disabledStyle: ViewStyle = {
      opacity: 0.6,
      backgroundColor: variant === 'filled' ? `${theme.colors.muted}40` : 'transparent',
    };
  ...
  return (
    <Container>
      <Stack gap="xl">
        ...
        <Typography type="body" color={theme.colors.mutedForeground}>
